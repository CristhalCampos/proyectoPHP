      ...
      <div>
        ...
        <form name="form" method="POST">
          <div>
            ...
            <input type="text" name="first-name" id="first-name" placeholder="Juan" autocomplete="on" required>
            <span id="valid1">El nombre debe tener al menos 2 letras, no puede tener números</span>
          </div>
          <div>
            <label for="last-name">Apellido:</label>
            <input type="text" name="last-name" id="last-name" placeholder="Rodriguez" autocomplete="on" required>
            <span id="valid2">El apellido debe tener al menos 2 letras, no puede tener números</span>
          </div>
          <div>
            <label for="email">Correo:</label>
            <input type="email" name="email" id="email" placeholder="juanrodriguez@gmail.com" autocomplete="on" required>
          ...
          <div id="div-register">
            <button type="submit" id="register" disabled>Registrar</button>
            <span id="response"></span>
          </div>
        </form>
        <?php
          require_once '../controllers/authentController.php';
          if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['first-name'], $_POST['last-name'], $_POST['email'], $_POST['password'])) {
